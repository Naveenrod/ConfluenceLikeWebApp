...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <form action="<?php echo e(route('pages.store')); ?>" method="POST" class="bg-white shadow rounded-lg p-6">
        <?php echo csrf_field(); ?>
        ...
        <div class="mb-4">
            ...
            <select name="space_id" id="space_id" required
                ...
                <?php $__currentLoopData = $spaces; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $space): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($space->id); ?>" <?php echo e(old('space_id', $spaceId) == $space->id ? 'selected' : ''); ?>>
                        <?php echo e($space->name); ?>

                    </option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
            <?php $__errorArgs = ['space_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <?php if($parent): ?>
            <div class="mb-4">
                ...
                <p class="text-sm text-gray-600">Parent page: <strong><?php echo e($parent->title); ?></strong></p>
            </div>
        <?php else: ?>
            <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <?php echo $__env->make('components.tinymce-editor', ['id' => 'content', 'name' => 'content', 'value' => old('content')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="flex justify-end space-x-3">
            <a href="<?php echo e($parent ? route('pages.show', $parent->id) : route('spaces.index')); ?>" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/naveenrodrigo/Documents/ConfluenceLikeWebApp/resources/views/pages/create.blade.php ENDPATH**/ ?>